...
const position = buttonToClick === null || buttonToClick === void 0 ? void 0 : buttonToClick.getBoundingClientRect();
buttonToClick === null || buttonToClick === void 0 ? void 0 : buttonToClick.addEventListener("click", handleClick);
let isSetup = false;
let currentPositionX = position === null || position === void 0 ? void 0 : position.x;
let currentPositionY = position === null || position === void 0 ? void 0 : position.y;
let currentClientX;
let currentClientY;
...
function checkInitialCursorPosition(event) {
    ...
    if (buttonToClick && currentPositionX && currentPositionY) {
        const isWithinButtonQuadrants = (initialCursorCoordX >= currentPositionX - 10 &&
...
function handleClick() {
    const position = buttonToClick === null || buttonToClick === void 0 ? void 0 : buttonToClick.getBoundingClientRect();
    console.log(position === null || position === void 0 ? void 0 : position.x, position === null || position === void 0 ? void 0 : position.y);
    if (buttonToClick) {
...
function handleButtonMovement(event) {
    if (buttonToClick && currentPositionX !== undefined && currentPositionY !== undefined) {
        const inFirstQuadrant = event.clientX >= currentPositionX + 51 &&
            event.clientX <= currentPositionX + 110 &&
            event.clientY >= currentPositionY - 10 &&
            event.clientY <= currentPositionY + 25;
        const inSecondQuadrant = event.clientX >= currentPositionX - 10 &&
            event.clientX <= currentPositionX + 50 &&
            event.clientY >= currentPositionY - 10 &&
            event.clientY <= currentPositionY + 25;
        const inThirdQuadrant = event.clientX >= currentPositionX - 10 &&
            event.clientX <= currentPositionX + 50 &&
            event.clientY >= currentPositionY + 26 &&
            event.clientY <= currentPositionY + 60;
        const inFourthQuadrant = event.clientX >= currentPositionX + 51 &&
            event.clientX <= currentPositionX + 110 &&
            event.clientY >= currentPositionY + 26 &&
            event.clientY <= currentPositionY + 60;
        if (inFirstQuadrant) {
...
function returnTimer(button) {
    if (buttonMoved)
        return;
    let newPositionX = randomGenerator(250, currentViewportWidth - 250);
    let newPositionY = randomGenerator(250, currentViewportHeight - 250);
    ...
    setTimeout(() => {
        ...
        const cursorIsOnButton = (currentClientX >= newPositionX - 10 && currentClientX <= newPositionX + 110) ||
